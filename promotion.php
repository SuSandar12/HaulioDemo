<div class="container">
  <div class="row">
    <div class="col-md-6 col-lg-6 col-xs-12 mt-4 ">
        <p class="txt-p1-1">FRESH FOOD FOR A FRESHER YOU</p><br>
        <i class="txt-p1-2">Quality food, Quality life</i>
    </div>
    <div class="col-md-6 col-lg-6 col-xs-12 mt-4 ">
        <img src="assets/img/Side image.png" class="img-fluid" alt="side image"/>
    </div>
  </div>
</div>
